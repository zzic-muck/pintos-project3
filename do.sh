...
SWAP_FILE="pintos --gdb -v -k -T 1809999999999999999999999999999999999999999999999999999999999999999999999999 -m 8   --fs-disk=10 -p tests/vm/swap-file:swap-file -p ../../tests/vm/large.txt:large.txt --swap-disk=10 -- -q   -f run swap-file"
